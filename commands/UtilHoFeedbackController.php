...
class UtilHoFeedbackController extends Controller
{
    public function actionCreateSqlHoResultView()
    {
        ...
        $data_player = array('id', 'tsi', 'salary', 'age', 'age_days', 'experience', 'form', 'stamina', 'injury_status', 'keeper', 'playmaking', 'passing', 'winger', 'defending', 'scoring', 'set_pieces', 'loyalty', 'mother_club');
